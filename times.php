...
<?php
   ...
   $path .= urlencode("SELECT * FROM feed WHERE url='http://fulltextrssfeed.com/dynamic.feedsportal.com/pf/555218/toi.timesofindia.indiatimes.com/rssfeedstopstories.cms'");
   $path .= "&format=json";
